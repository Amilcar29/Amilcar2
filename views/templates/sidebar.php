    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <!-- Configuración -->
                <li class="nav-item <?php echo (isset($_GET['controller']) && ($_GET['controller'] == 'area' || $_GET['controller'] == 'department' || $_GET['controller'] == 'role')) ? 'menu-open' : ''; ?>">
                    <a href="#" class="nav-link <?php echo (isset($_GET['controller']) && ($_GET['controller'] == 'area' || $_GET['controller'] == 'department' || $_GET['controller'] == 'role')) ? 'active' : ''; ?>">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="index.php?controller=role&action=index" class="nav-link <?php echo (isset($_GET['controller']) && $_GET['controller'] == 'role') ? 'active' : ''; ?>">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Roles</p>
                            </a>
                        </li>
