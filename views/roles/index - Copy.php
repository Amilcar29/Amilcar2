                                ...
                                <?php if (!empty($roles)): ?>
                                    <?php foreach ($roles as $role): ?>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    <a href="index.php?controller=role&action=edit&id=<?php echo $role['id']; ?>" class="btn btn-xs btn-warning" title="Editar rol">
                                                        <i class="fas fa-edit"></i>
                                                    </a>
                                                    <?php if ($role['id'] > 5): // No permitir eliminar roles del sistema ?>
